    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cookie_samesite', models.CharField(choices=[('Lax', 'Lax'), ('Strict', 'Strict'), ('None', 'None')], default='Lax', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['user_id', 'tenant_id'], name='token_manag_user_id_fb8027_idx'), models.Index(fields=['device_id'], name='token_manag_device__f562e1_idx'), models.Index(fields=['is_revoked'], name='token_manag_is_revo_5ca1c4_idx'), models.Index(fields=['expires_at'], name='token_manag_expires_93ae56_idx')],
            },
        ),
    ]
